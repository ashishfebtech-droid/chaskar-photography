    ...
    <footer className="relative bg-gray-900 text-white z-10" role="contentinfo">
        ...
        <div className="footer-inner-wrapper max-w-7xl mx-auto px-4 md:px-6 flex flex-col lg:flex-row gap-8 lg:gap-0 w-full">
          ...
          <div className="footer-right flex-1 lg:flex-[0_0_60%] xl:flex-[0_0_65%] flex flex-col gap-8 lg:gap-10 lg:pl-6 mt-8 lg:mt-0">
            ...
            <div className="footer-right-top grid md:grid-cols-3 gap-4 lg:gap-6">
              {/* Email */}
              <a href="mailto:Vineechaskar@gmail.com" className="contact-item flex flex-col gap-3 no-underline group p-4 lg:p-5 bg-gray-800 rounded-xl border border-gray-700 hover:border-[#e0b56f]/50 transition-all duration-300">
              ...
              {/* Telephone */}
              <a href="tel:+919557867881" className="contact-item flex flex-col gap-3 no-underline group p-4 lg:p-5 bg-gray-800 rounded-xl border border-gray-700 hover:border-[#e0b56f]/50 transition-all duration-300">
                <div className="contact-icon w-10 h-10 lg:w-12 lg:h-12 bg-[#e0b56f]/20 rounded-lg flex items-center justify-center text-[#e0b56f] text-lg lg:text-xl transition-all duration-300 group-hover:bg-[#e0b56f]/30 group-hover:-translate-y-1">
                  <FaPhone />
                </div>
                <div>
              ...
              <a
                ...
                className="contact-item flex flex-col gap-3 no-underline group p-4 lg:p-5 bg-gray-800 rounded-xl border border-gray-700 hover:border-[#e0b56f]/50 transition-all duration-300"
              >
                <div className="contact-icon w-10 h-10 lg:w-12 lg:h-12 bg-[#e0b56f]/20 rounded-lg flex items-center justify-center text-[#e0b56f] text-lg lg:text-xl transition-all duration-300 group-hover:bg-[#e0b56f]/30 group-hover:-translate-y-1">
                  <FaMapMarkerAlt />
                </div>
              ...
              <div className="footer-links-column">
                ...
                <div className="social-links flex flex-col gap-2 lg:gap-3">
                  <a href="https://www.facebook.com/chaskarphoto" className="flex items-center gap-3 text-gray-200 no-underline transition-all duration-300 hover:text-[#e0b56f] group">
                    <div className="w-8 h-8 lg:w-9 lg:h-9 bg-gray-800 rounded-lg flex items-center justify-center group-hover:bg-[#e0b56f]/20 transition-colors duration-300">
      ...
      <div className="footer-container-2 bg-[#e0b56f] py-5 relative z-10">
        <div className="footer-bottom-content max-w-7xl mx-auto px-4 md:px-6 flex justify-center items-center">
          <p className="copyright text-black text-sm font-medium m-0 text-center">
